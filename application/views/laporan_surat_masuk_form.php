<!-- Main content -->
        ...
        <form action="<?php echo base_URL(); ?>index.php/laporan_surat_masuk/cetak_surat_masuk"  target="_blank" method="get" enctype="multipart/form-data" ><table class='table table-bordered'>
	   <?php
	   ...
	   <tr><td>Sampai Tanggal </td>
	    ...
	    <a href="<?php echo site_url('input_surat_masuk') ?>" class="btn btn-default">Kembali</a></td></tr>
