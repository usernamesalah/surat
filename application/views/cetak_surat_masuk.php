...
<body onload="window.print()">
	...
	Dari tanggal <b><?php echo indonesian_date($tgl_start)."</b> sampai dengan tanggal <b>".indonesian_date($tgl_end)."</b>"; ?>
	</center><br>
	...
	<table>
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo gval("admin", "id", "nama", $d->pengolah); ?></td>
				<td><?php echo indonesian_date($d->tgl_diterima); ?></td>
