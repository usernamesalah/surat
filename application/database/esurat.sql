...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2016 at 08:44 AM
...
INSERT INTO `admin` (`id`, `username`, `password`, `nama`, `nip`, `level`) VALUES
(1, 'admin', '0192023a7bbd73250516f069df18b500', 'Hermanto', '19900326 201401 1 002', 'Super Admin'),
(5, 'user', 'ee11cbb19052e40b07aac0ca060c23ee', 'Iwan Setiawan', '6666', 'Admin'),
(7, 'user2', 'ee11cbb19052e40b07aac0ca060c23ee', 'User2', '000232wwe', 'Admin'),
(8, 'abi', 'a6b1f718159f7cda6fe459a9ca22e40a', 'abi', 'wee', 'Admin');
...
--
-- Dumping data for table `input_surat_keluar`
--
...
(2, 'fds', '0002', 'dfsd', 'dfd', 'fsd', '2016-02-08', '2016-02-10', 'fsdfds', '', 4);
...
CREATE TABLE `input_surat_masuk` (
  ...
  `no_agenda` varchar(250) NOT NULL,
...
--
-- Dumping data for table `input_surat_masuk`
--
...
(1, 'HM', '0001', 'data', 'Permintaan data kunjungan wisatawan semester 1 tahun 2015', 'Dinas Pariwisata DIY', 'Par/HM.01/100/2015', '2015-05-22', '2015-05-24', 'sdsdsd', 'isian-epupns.docx', 1),
(5, 'KU.00', '0004', 'fsd', 'sdfdsf', 'sds', 'fsfd', '2016-02-01', '2016-02-10', 'dfd', 'fsdfds', 4),
(6, 'KU.00.1', '0005', 'berkas', 'fffd', 'dari luar', '999', '2016-02-08', '2016-02-10', 'dfdf', '', 4);
...
INSERT INTO `instansi_pengguna` (`id`, `nama`, `alamat`, `kepsek`, `nip_kepsek`, `logo`) VALUES
(1, 'Dinas Kesehatan Kabupaten OKI ', 'Jl. Kayuagung OKI', 'Drs. Hendrodiningrat, M.Si', '199003262016011001', 'ok-1-3-keren.jpg');
...
(1, 'Menu Manajemen', 'menu', 'fa fa-list-alt', 1, 0),
(21, 'Master', '#', 'fa fa-list', 1, 0),
(22, 'Klasifikasi Surat', 'klasifikasi_surat', 'fa fa-circle-o', 1, 21),
(23, 'Input Surat', '#', 'fa fa-random', 1, 0),
(24, 'Surat Masuk', 'input_surat_masuk', 'fa fa-circle-o', 1, 23),
(25, 'Surat Keluar', 'input_surat_keluar', 'fa fa-circle-o', 1, 23),
(26, 'Laporan', '#', 'fa fa-pie-chart', 1, 0),
(27, 'Surat Masuk', 'laporan_surat_masuk', 'fa fa-circle-o', 1, 26),
(28, 'Surat Keluar', 'laporan_surat_keluar', 'fa fa-circle-o', 1, 26),
(29, 'Pengaturan', '#', 'fa fa-laptop', 1, 0),
(30, 'Instansi Pengguna', 'instansi_pengguna', 'fa fa-circle-o', 1, 29),
(31, 'Manajemen Admin', 'admin', 'fa fa-circle-o', 1, 29);
...
(2, 5, 'Kadin', 'Isinya adalah', 'Segera', '2016-02-09', 'penting'),
(4, 4, 'kkkkd', 'vdfvdf', 'Biasa', '2016-02-17', '');
