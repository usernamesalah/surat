...
class Klasifikasi_surat_model extends CI_Model
{
    ...
    public $table = 'klasifikasi_surat';
    public $id = 'id';
    public $order = 'DESC';
    ...
    function tampil_klasifikasi_surat()
    {
...
/* End of file Klasifikasi_surat_model.php */
/* Location: ./application/models/Klasifikasi_surat_model.php */
